...
### After generation
The tool returns `url` (first image) and `urls` (all images). These are displayed inline in the chat automatically — you don't need to embed them in Markdown. Just write a short description of what you generated.
